class RainwaveListener(object):
    ...
    def topalbums(self):
        ...
        _topalbums = []
        for album in self._get_extended(u'user_topalbums'):
            new_album = self.channel.get_album_by_name(album[u'album_name'])
